              ...
              <li className="side-nav__item">
                ...
                <div className='Dashboard'>
                  <div>
                    ...
                    <div><span className="text">Dashboard</span></div>
                </div>
                  </Link>
              </li>
              <li className="side-nav__item">
                ...
                <div className='Dashboard'>
                  <div>
                    <span className="icon">
                      <img src='/assets/usersListIcon.png' style={{height: '20px'}}/>
                    </span>
                  </div>
                    <div><span className="text">UsersList</span></div>
                </div>
                </Link>
              </li>
              <li className="side-nav__item">
                ...
                <div className='Dashboard'>
                  <div>
                    <span className="icon">
                      <img src='/assets/categoriesListIcon.png' style={{borderRadius: '50%'}}/>
                    </span>
                  </div>
                  <div><span className="text">CategoriesList</span></div>
                </div>
                </Link>
              </li>
              <li className="side-nav__item">
                ...
                <div className='Dashboard'>
                  <div>
                    <span className="icon">
                      <img src='/assets/paymentListIcon.png' style={{borderRadius: '50%'}}/>
                    </span>
                  </div>
                  <div><span className="text">PaymentList</span></div>
                </div>
                </Link>
              </li>
              <li className="side-nav__item">
                <button type='submit' onClick={logout}>
                  <div className='Dashboard'>
                      ...
                      <div><span className="text" style={{color: 'rgb(255, 217, 3)'}}>logout</span></div>
                  </div>
                </button>
              </li>
            </ul>
